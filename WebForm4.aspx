<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="book2.WebForm4" %>
...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <!--Update-->
                        <button type="button" id="btn-update" class="btn btn-info btn-xs" onclick="onUpdate()" hidden="hidden">Update</button>
                        <!--Cancle-->
                        <button type="button" id="btn-cancle" class="btn btn-info btn-xs" hidden="hidden">Cancle</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        //select2(ECA with multiple dropdown)
        $(document).ready(function () {
        ...
        $("#submitButton").click(function (event) {
            ...
            if (validateForm()) {
                ...
                var data = {
                    ...
                    mark: $("#mark").val(),
                    marks: $("#marks").val(), Completion: $("#Completion").val(),
        ...
        function onUpdate() {
            ...
            if (a == "") {
                ...
                Swal.fire({
                    ...
                    title: 'Oops...',
                    text: 'Something missing!',
                    footer: '<a href="">please select your gender</a>'
                })
            }
            else if (e == "") {
                valid = false;
                ...
                Swal.fire({
                    ...
                    title: 'Oops...',
                    text: 'Something missing!',
                    footer: '<a href="">please fill the  Section </a>'
                })
            }
            else if (ECA == "") {
                valid = false;
                Swal.fire({
                    ...
                    title: 'Oops...',
                    text: 'Something missing!',
                    footer: '<a href="">please fill the  Extracaricular Activities </a>'
                })
            }
            else if (Quota === undefined) { // check if Quota is not selected
                valid = false;
                Swal.fire({
                    ...
                    title: 'Oops...',
                    text: 'Something missing!',
                    footer: '<a href="">please select your Quota</a>'
                })
            }
            else if (l == "") {
                valid = false;
